...
RSpec.describe 'Posts', type: :system do
  ...
  describe 'User post index page' do 
    ...
    let (:comment) {Comment.create(user:user,post:first_post,text:"Nice one")}
    ...
    it 'shows the basic info for the user' do
      ...
      expect(page).to have_css('span.post-footer',text:"Comments: #{first_post.comments_counter}, Likes: #{first_post.likes_counter}")
  ...
  describe 'Post show page' do
    ...
    it 'shows the post info' do
      ...
      expect(page).to have_css('span.post-header',text:"Comments: #{first_post.comments_counter}, Likes: #{first_post.likes_counter}")
